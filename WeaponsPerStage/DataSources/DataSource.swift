...
class DataSource: NSObject {
    ...
    /// ステージデータ
    static let stageList = ["デカライン高架下", "ハコフグ倉庫", "シオノメ油田", "アロワナモール", "Bバスパーク", "ホッケふ頭", "モズク農園", "タチウオパーキング", "ネギトロ炭鉱", "モンガラキャンプ場", "ヒラメが丘団地", "マサバ海峡大橋", "キンメダイ美術館", "マヒマヒリゾート＆スパ", "ショッツル鉱山", "アンチョビットゲームズ"]
